...
// sqlOpen is a seam for tests to override otelsql.Open.
var sqlOpen = otelsql.Open

// NewDatabase initializes and returns a database/sql connection using pgx driver.
func NewDatabase(log *logrus.Logger, config *env.Config) *sql.DB {
